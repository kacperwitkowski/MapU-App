...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  <p>We've received a request to reset the password for your MapU account associated with ${email}. No changes have been made to your account yet. You can reset your password by clicking <a href="https://mapu.cyclic.app/resetpassword/${resetToken}">this link</a>. If you haven't forget your password please ignore this email!</p><footer>--The MapU team</footer>`;
